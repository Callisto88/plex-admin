...
public class Acteur implements Serializable {
	...
	public String getDateNaissanceToString(){
		...
		if (dateNaissance != null) {
			return simpleDateFormat.format(dateNaissance.getTime());
		}
	...
	public String getDateDecesToString(){
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd-M-yyy");
		if (dateDeces != null) {
			return simpleDateFormat.format(dateDeces.getTime());
		}
